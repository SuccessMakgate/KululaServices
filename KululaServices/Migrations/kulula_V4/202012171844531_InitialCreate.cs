    ...
    public partial class InitialCreate : DbMigration
    {
        public override void Up()
        {
                ...
                c => new
                    {
                        ...
                        IsScheduleFound = c.Boolean(nullable: false),
                        memberIDF = c.String(),
            ...
            CreateTable(
                ...
                c => new
                    {
                        DiscountRef = c.String(nullable: false, maxLength: 128),
                        MembersEmail = c.String(),
                        TransnDate = c.DateTime(nullable: false),
                        discount = c.Double(nullable: false),
                        kululaPoints = c.Int(nullable: false),
                        PaymentId = c.Int(nullable: false),
                    })
                .PrimaryKey(t => t.DiscountRef);
